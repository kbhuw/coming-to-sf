...
export default function Home(){
  ...
  return <main className="atlas">
    <header className="topbar"><a className="wordmark" href="/coming-to-sf/" aria-label="Coming to SF home"><span className="brand-symbol"><ArrowUpRight size={23}/></span><span>coming to <b>SF</b><span className="brand-period">.</span></span></a><button className="about-button" onClick={()=>setAbout(true)}><Info size={16}/><span>Sources & coverage</span></button></header>
